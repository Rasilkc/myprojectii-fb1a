[myprojectii-fb1a] Operating Details
====================================

Generated On: 2024-11-14 21:04:05 UTC
...
.. important::
   ...
   **not be valid if your [myprojectii-fb1a] container is NOT running**.

.. tip::
   You must have your [myprojectii-fb1a] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35155  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rasilkc'  \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env MQTTUSERNAME='Rasilkc'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   rasilkc98/myprojectii-fb1a-amd64 (https://hub.docker.com/r/rasilkc98/myprojectii-fb1a-amd64)
...
.. important::
   docker run -d -p 52017:52017 -p 59867:59867 -p 44447:44447 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=myprojectii-fb1a \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-myprojectii-fb1a \-\-env GITUSERNAME=Rasilkc  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=52017  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=59867  \-\-env SOLUTIONVIPERVIZPORT=44447 \-\-env DOCKERUSERNAME='rasilkc98' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=35155 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='Rasilkc' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rasilkc98/myprojectii-fb1a-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=44447
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=52017
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - rasilkc98/myprojectii-fb1a-amd64
...
It can be accessed by entering: http://localhost:59867
...
.. important::
   http://localhost:44447/tml-cisco-network-privategpt-monitor.html’?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:44447/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:44447/<html file>
...
[myprojectii-fb1a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Rasilkc/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myprojectii-fb1a
...
.. important::
   https://myprojectii-fb1a.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-myprojectii-fb1a
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52017, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36919, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38169, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40979, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41653, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36609, HPDEHOST=127.0.1.1, HPDEPORT=42575, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40893

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5387-myprojectii-fb1a,solution_preprocessing_ai_mqtt_dag-myprojectii-fb1a, python-preprocess-2472-myprojectii-fb1a,solution_preprocessing_ai_mqtt_dag-myprojectii-fb1a, python-ai-558-myprojectii-fb1a,solution_preprocessing_ai_mqtt_dag-myprojectii-fb1a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
